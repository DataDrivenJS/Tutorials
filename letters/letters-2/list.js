...
function loadViews (){
    DD.reader.read('3610a2cd0ee2b49aeed38bde9e06192a/Session_listGroupedDatapointsByFilters/2d0e7c60824f2263698810b0472539c4',{}, function(response){
        itemsUl.dataset.viewsLoaded = '1';
        var letterLinks = document.querySelectorAll('.items > ul a');
        var lettersIndex = {};
        for (var i = 0; i<letterLinks.length; i++){       
            lettersIndex[letterLinks[i].href] = letterLinks[i];
            console.log(letterLinks[i].href);
